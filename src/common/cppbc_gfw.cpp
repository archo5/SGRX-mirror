...
int GOResource::_sgs_getindex( SGS_ARGS_GETINDEXFUNC )
{
	...
	SGS_BEGIN_INDEXFUNC
		...
		SGS_CASE( "name" ){ sgs_PushVar( C, static_cast<GOResource*>( obj->data )->m_name ); return SGS_SUCCESS; }
...
int GOResource::_sgs_setindex( SGS_ARGS_SETINDEXFUNC )
{
	...
	SGS_BEGIN_INDEXFUNC
		...
		SGS_CASE( "name" ){ static_cast<GOResource*>( obj->data )->m_name = sgs_GetVar<sgsString>()( C, 1 ); return SGS_SUCCESS; }
...
int GOResource::_sgs_dump( SGS_CTX, sgs_VarObj* obj, int depth )
{
	...
	if( depth > 0 )
	{
		...
		{ sgs_PushString( C, "\nname = " ); sgs_DumpData( C, static_cast<GOResource*>( obj->data )->m_name, depth ).push( C ); }
...
int GOBehavior::_sgs_getindex( SGS_ARGS_GETINDEXFUNC )
{
	...
	SGS_BEGIN_INDEXFUNC
		...
		SGS_CASE( "name" ){ sgs_PushVar( C, static_cast<GOBehavior*>( obj->data )->m_name ); return SGS_SUCCESS; }
...
int GOBehavior::_sgs_setindex( SGS_ARGS_SETINDEXFUNC )
{
	...
	SGS_BEGIN_INDEXFUNC
		...
		SGS_CASE( "name" ){ static_cast<GOBehavior*>( obj->data )->m_name = sgs_GetVar<sgsString>()( C, 1 ); return SGS_SUCCESS; }
		SGS_CASE( "__type" ){ static_cast<GOBehavior*>( obj->data )->m_type = sgs_GetVar<sgsString>()( C, 1 ); return SGS_SUCCESS; }
...
int GOBehavior::_sgs_dump( SGS_CTX, sgs_VarObj* obj, int depth )
{
	...
	if( depth > 0 )
	{
		...
		{ sgs_PushString( C, "\nname = " ); sgs_DumpData( C, static_cast<GOBehavior*>( obj->data )->m_name, depth ).push( C ); }
...
int MeshEntity::_sgs_setindex( SGS_ARGS_SETINDEXFUNC )
{
	...
	SGS_BEGIN_INDEXFUNC
		...
		SGS_CASE( "position" ){ static_cast<MeshEntity*>( obj->data )->SetWorldPosition( sgs_GetVar<Vec3>()( C, 1 ) ); return SGS_SUCCESS; }
...
int LightEntity::_sgs_setindex( SGS_ARGS_SETINDEXFUNC )
{
	...
	SGS_BEGIN_INDEXFUNC
		...
		SGS_CASE( "position" ){ static_cast<LightEntity*>( obj->data )->SetWorldPosition( sgs_GetVar<Vec3>()( C, 1 ) ); return SGS_SUCCESS; }
...
int MeshResource::_sgs_getindex( SGS_ARGS_GETINDEXFUNC )
{
	...
	SGS_BEGIN_INDEXFUNC
		...
		SGS_CASE( "name" ){ sgs_PushVar( C, static_cast<MeshResource*>( obj->data )->m_name ); return SGS_SUCCESS; }
...
int MeshResource::_sgs_setindex( SGS_ARGS_SETINDEXFUNC )
{
	...
	SGS_BEGIN_INDEXFUNC
		...
		SGS_CASE( "name" ){ static_cast<MeshResource*>( obj->data )->m_name = sgs_GetVar<sgsString>()( C, 1 ); return SGS_SUCCESS; }
...
int MeshResource::_sgs_dump( SGS_CTX, sgs_VarObj* obj, int depth )
{
	...
	if( depth > 0 )
	{
		...
		{ sgs_PushString( C, "\nname = " ); sgs_DumpData( C, static_cast<MeshResource*>( obj->data )->m_name, depth ).push( C ); }
