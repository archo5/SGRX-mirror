...
void BRSD4Player::FixedTick( float deltaTime )
{
...
void BRSD4Player::Tick( float deltaTime, float blendFactor )
{
...
bool BRSD4Player::AddItem( const StringView& item, int count )
{
	String key = item;
...
bool BRSD4Player::HasItem( const StringView& item, int count )
{
